...
#define UpperNibble_BitMask_Command	 	(Command & 0xF0) //send upper 4 bit
#define LowerNibble_BitMask_Command  	 (Command << 4)	//send lower 4 bit

#define UpperNibble_BitMask_Data 		(Data & 0xF0)	 //send upper 4 bit
#define LowerNibble_BitMask_Data  		(Data << 4)		//send lower 4 bit
