...
//#define Timer2_Counter_Disabled
//#define Timer2_CLK_No_Prescaler
//#define Timer2_CLK_8_Prescaler
//#define Timer2_CLK_64_Prescaler
//#define Timer2_CLK_256_Prescaler
//#define Timer2_CLK_1024_Prescaler
//#define Timer2_CLK_External_FallingEdge_CounterMode //On Pin T0
//#define Timer2_CLK_External_RisingEdge_CounterMode //On Pin T0
/**********************************************WatchDog*************************************************/
//#define Vcc_5_Volt
//#define Vcc_3_Volt
...
/***********************************************TIMER 1**************************************************/
/******************************************Channel Selection*********************************************/
#define TIMER1_ChannelA	/*OCRA -> PORTD pin5 in Atmega32*/
//#define TIMER1_ChannelB		/*OCRB -> PORTD pin4 in Atmega32*/
/****************************************CTC Mode Selection*********************************************/
...
/*****************************************CTC Mode Selection*********************************************/
/*********************************WaveMode Generation Mode Selection************************************/
//#define Timer2_Normal_Timer_Mode
//#define Timer2_CTC_Timer_Mode
//#define Timer2_PhaseCorrect_PWM_Mode
//#define Timer2_Fast_PWM_Mode
/*****************************Compare Output Mode/ Non PWM Mode Selection*******************************/
/*OC2 -> PIND7 in Atmega32*/
//#define Normal_PORT_Operation //OC2 Disconnected event not interrupt
//#define Toggle_OC2_Value
//#define Clear_OC2_Value
//#define SET_OC2_Value
/*****************************Compare Output Mode/ Fast PWM Mode Selection*******************************/
//#define Normal_PORT_Operation 		//OC2 Disconnected event not interrupt
///#define ClearCompareMatch_SetTop_OC2	//Non_Inverted Mode
//#define SetCompareMatch_ClearTop_OC2	//Inverted Mode
/*****************************Compare Output Mode/ Phase PWM Mode Selection******************************/
//#define Normal_PORT_Operation 										//OC2 Disconnected
//#define Clear_OC2_CompareMatchCountUP_Set_OC2_CompareMatchCountDown	//Non_Inverted Mode
//#define Set_OC2_CompareMatchCountUP_Clear_OC2_CompareMatchCountDown	//Inverted Mode
